    ...
    <div class="col-xs-3"></div>
      <div class="col-xs-6">
        <div class="box box-danger">
            ...
            <a href="{{ route('danh-sach-danh-muc-danh-gia') }}" class="btn btn-danger margin btn-labeled" style="position: relative;padding-left: 50px"><b><i class="fa fa-close"></i></b>Close</a>
        </div>
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Thêm Danh Mục Đánh Giá</h3>
          ...
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-4 control-label">Tên danh mục đánh giá</label>
              <div class="col-sm-8">
