@extends('admin.app')
@section('title','Cập nhật thông tin tag')
@section('content')
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="txtCateName" value="{!!old('txtCateName', $data["tentag"])!!}" >
              </div>
            </div>
             <div class="form-group">
              <label class="col-sm-12 control-label">Mô tả tag:</label>
                <div class="col-sm-12">
                <textarea name="txtdes" rows="5" class="textbox" value="" >{!!old('txtdes', isset($data["motatag"]) ? $data["motatag"]:null)!!}</textarea>
