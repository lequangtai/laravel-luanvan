                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead class="thead">
                      <tr>
                        ...
                        <th style="text-align: center;">Mô Tả Tag</th>
                    ...
                    <tr>
                      ...
                      <td>{{ $dmt["motatag"] }}</td>
                       <td class="list_td aligncenter">{!! \Carbon\Carbon::createFromTimeStamp(strtotime($dmt['created_at']))->diffForHumans() !!}</td>
                        <td>
                        <a href="{!!route('gettagEdit', ['id'=>$dmt["id"]])!!}"><i class="fa  fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
                        <a href="{!!route('gettagDel', ['id'=>$dmt["id"]])!!}"onclick = "return xacnhanxoa ('Bạn có muốn xóa không?')"><i class="fa  fa-trash-o"></i></a>
                        </td>
                    </tr>
                  @endforeach()
