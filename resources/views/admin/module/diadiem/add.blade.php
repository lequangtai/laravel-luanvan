        ...
        <div class="box box-default">
          ...
          <div class="box-body" style="padding-left: 200px">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="txtTen" placeholder="Nhập tên" style="width: 500px">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Tên đăng nhập</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="tendn" placeholder="Nhập tên" style="width: 500px">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="txtDiachi" placeholder="Nhập địa chỉ" style="width: 500px">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Email</label>
              <div class="col-sm-10">
                <input type="email" class="form-control" name="txtEmail" placeholder="Nhập email" style="width: 500px">
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">Điện Thoại</label>                      
              <div class="col-sm-10">
                <input type="text" class="form-control" name="txtSDT" id="inputPassword3" placeholder="SĐT" style="width: 500px">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="password" class="form-control" name="txtPass" id="inputPassword3" placeholder="Password" style="width: 500px">
              </div>
            </div>
            </div>
          </div>
