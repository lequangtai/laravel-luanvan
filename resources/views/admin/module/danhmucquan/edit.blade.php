        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="txtCateName" value="{!!old('txtCateName', $quan["tenquan"])!!}" >
              </div>
            </div>
             <div class="form-group ">
              <label class="col-sm-2" style="padding-right: 150px">Tỉnh Thành</label>
              <select class="col-sm-6 select2" name="sltLophoc"><?php menuMulti10($tinh) ?>
