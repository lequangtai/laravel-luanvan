@extends('admin.app')
@section('title','Cập nhật thông tin danh mục món ăn')
@section('content')
      ...
      <div class="col-xs-6">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Sửa Danh Mục Món Ăn</h3>
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="txtCateName" value="{!!old('txtCateName', $data["ten_DMMA"])!!}" >
              </div>
            </div>
          </div>
        </div>
