  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="hidden-xs">Xin chào <b style="color: red">{{ Auth::user()->tendangnhap }}</b></span>
                </a>
              </li>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-star-half-o"></i> Danh sách bình luận</a></li>
               <!--  <li><a href="#"><i class="fa fa-star-half-o"></i> Thêm người dùng</a></li>
                <li><a href="#"><i class="fa fa-star-half-o"></i> Phân công giảng dạy</a></li> 
                <li><a href="#"><i class="fa fa-star-half-o"></i> Lịch giảng dạy</a></li> -->
              </ul>
            </li>
            <li class="treeview">
              <a href="">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li ><a  href="#"><i class="fa fa-star-half-o"></i>ffghhg</a></li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="http://almsaeedstudio.com"> Quản lý website Tìm kiếm địa điểm ăn uống</a>.</strong>
      </footer>
