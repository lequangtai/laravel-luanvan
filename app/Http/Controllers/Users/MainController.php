...
class MainController extends Controller
{
    ...
    public function getIndex(){
     ...
     public function getbasicslider(){
        return view('User.page.link.basic-slider');
    }
     public function getaccordionslider(){
        return view('User.page.link.accordion-slider');
    }
     public function getthumbslider(){
        return view('User.page.link.thumb-slider');
    }
     public function getnivoslider(){
        return view('User.page.link.nivo-slider');
    }
      public function getrightslider(){
        return view('User.page.link.right-slider');
    }
     public function getrecipes(){
        return view('User.page.link.recipes');
    }
     public function getsinglesb(){
        return view('User.page.link.single-sb');
    }
     public function getsinglefull(){
        return view('User.page.link.single-full');
    }
     public function getservices(){
        return view('User.page.link.services');
    }
     public function getblog(){
        return view('User.page.link.blog');
    }
     public function getsingle(){
        return view('User.page.link.single');
    }
     public function getpage(){
        return view('User.page.link.page');
    }
     public function getfaq(){
        return view('User.page.link.faq');
    }
     public function getfeatures(){
        return view('User.page.link.features');
    }
     public function getcontact(){
        return view('User.page.link.contact');
    }
    public function getlocation(){
        return view('User.page.link.location');
    }
    public function getmaps(){
        return view('User.page.link.maps');
    }
